...
/**
 * Anchor to display popups over the top-right of the application screen.
 */
public class TopRightAnchor extends PopupAnchor {

    private final double insetX;
    private final double insetY;

    /**
     * Construct an anchor to display alerts in the top right of the application screen
     * @param insetX the amount to inset relative to the x-axis
     * @param insetY the amount to inset relative to the y-axis
     */
    public TopRightAnchor(double insetX, double insetY) {
        this.insetX = insetX;
        this.insetY = insetY;
    }

    /**
     * Construct an anchor to display alerts in the bottom top of the application screen.
     * Applies default insets of (30, 60)
     */
    public TopRightAnchor() {
        this(30, 60);
    }
