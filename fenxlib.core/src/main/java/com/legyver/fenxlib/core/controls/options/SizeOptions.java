...
public class SizeOptions {
	...
	public static class Builder {
		private final OrientatedBuilder.WidthOrientatedBuilder width = new OrientatedBuilder.WidthOrientatedBuilder(this);
		private final OrientatedBuilder.HeightOrientatedBuilder height = new OrientatedBuilder.HeightOrientatedBuilder(this);

		/**
		 * Shortcut to the width builder
		 * @return the width builder
		 */
		public OrientatedBuilder.WidthOrientatedBuilder width() {
			return width;
		}
		 ...
		 */
		public OrientatedBuilder.HeightOrientatedBuilder height() {
			return height;
		}
