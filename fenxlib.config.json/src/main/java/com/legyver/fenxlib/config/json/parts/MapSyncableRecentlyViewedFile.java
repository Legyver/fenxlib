 ...
 */
public class MapSyncableRecentlyViewedFile implements RawMapAware, IRecentlyViewedFile {
	 ...
	 */
	public MapSyncableRecentlyViewedFile(Map sourceMap) {
	 ...
	 */
	public static MapSyncableRecentlyViewedFile parse(File file) throws CoreException {
		MapSyncableRecentlyViewedFile recentValue = new MapSyncableRecentlyViewedFile(new LinkedHashMap<>());
